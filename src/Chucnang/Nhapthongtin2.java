...
SinhvienT2 svT=new SinhvienT2();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 330, 370, 110));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 250, 80, -1));
 ...
 if( svT.Update(sv)>0)
 {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       Table3 flogin =new Table3();
       Logout2.LogOut5(this, flogin);
       this.dispose();
