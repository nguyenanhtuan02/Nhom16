...
SinhvienServide sinhvienServide;
    /**
     * Creates new form Table
     */
    public Table() {
        initComponents();
        sinhvienServide =new SinhvienServide();
        DefaultTableModel defaultTableModel =new DefaultTableModel();
        Usertable.setModel(defaultTableModel);
        defaultTableModel.addColumn("ID");
         defaultTableModel.addColumn("tênSV");
            ...
            defaultTableModel.addColumn("gioitinh");
             defaultTableModel.addColumn("diachi");
              defaultTableModel.addColumn("sdt");
               ...
               List<Sinhvien> users =sinhvienServide.getAll();
               for (Sinhvien user : users)
               {
                   defaultTableModel.addRow(new Object[]{user.getID(),user.getTenSV(),user.getMalop(),user.getTuoi(),user.getGioiTinh(),user.getDiaChi(),user.getSdt(),user.getEmail()});
               }
    }
