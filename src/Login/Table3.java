...
GiangvienServide sinhvienServide;
    /**
     * Creates new form Table
     */
    public Table3() {
        initComponents();
        sinhvienServide =new GiangvienServide();
        DefaultTableModel defaultTableModel =new DefaultTableModel();
        Usertable.setModel(defaultTableModel);
        defaultTableModel.addColumn("ID");
         defaultTableModel.addColumn("tênGV");
          defaultTableModel.addColumn("malop");
           defaultTableModel.addColumn("tuoi");
            defaultTableModel.addColumn("gioitinh");
             defaultTableModel.addColumn("diachi");
              defaultTableModel.addColumn("sdt");
               defaultTableModel.addColumn("Email");
               List<Giangvien> users =sinhvienServide.getAll();
               for (Giangvien user : users)
               {
                   defaultTableModel.addRow(new Object[]{user.getID(),user.getTenGV(),user.getMalop(),user.getTuoi(),user.getGioiTinh(),user.getDiaChi(),user.getSdt(),user.getEmail()});
               }
    }
